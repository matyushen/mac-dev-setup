...
# Install apps
brew cask install docker iterm2 google-chrome visual-studio-code slack spotify altair-graphql-client spectacle 1password graphql-playground webstorm github appcleaner discord figma firefox homebrew/cask-versions/firefox-developer-edition
