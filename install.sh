...
# Install apps
brew cask install docker iterm2 google-chrome visual-studio-code slack spotify ngrok spectacle 1password hyper graphql-playground webstorm github appcleaner figma firefox homebrew/cask-versions/firefox-developer-edition
